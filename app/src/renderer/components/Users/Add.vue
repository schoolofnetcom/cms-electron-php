  ...
  <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-11">
          <div class="card">
            <div class="card-body">
              <h5 class="title"><i class="fa fa-file-text-o"></i> Novo usuário <small>Inclusão de novo usuário</small></h5>
              ...
              <form @submit.prevent="save()">
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" id="password" placeholder="Uma senha segura" v-model="user.password">
                </div>
